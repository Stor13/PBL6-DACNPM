...
<html>
  ...
  <body>
    ...
    <main>
      <?php include_once $_SERVER["DOCUMENT_ROOT"]."/pbl5/php/_ui/php_templates/lecturer/quanly_khoahoc/danhsach_diem/index.php" ?>
    </main> 

    <footer>
    </footer>
    <!-- <script src="/pbl5/php/_ui/js/lecturer/quanly_khoahoc/index.js"></script> -->
  </body>
</html>