...
?>
<div class="container">
  <h5 class="text-center fw-bold">Them Giang vien moi vao Khoa hoc</h5>
</div>
<div class="container w-75 d-flex flex-wrap justify-content-between align-items-start">
  ...
  <div class="container-fluid w-75 d-flex flex-wrap justify-content-between align-items-start">
    <h5 class="fs-2"><span class="text-decoration-underline text-danger">Lỗi</span><span class="text-danger">:</span>&nbsp;Khoá học không tồn tại.</h5>
  </div>
  <?php } else { ?>
    ...
    <div id="content">
      <div class="container my-1">
        <form action="" method="post" id="themmoi_giangvien_khoahoc_form">
          ...
          <div class="form-group row mb-1">
            <label for="input_UserID" class="col-sm-4 col-form-label">Mã Giảng viên</label>
            <div class="col-sm-7">
  ...
  <div class="p-1 w-25 border-start border-bottom">
    ...
    <div class="row p-1">
      <a href="/pbl5/php/_ui/admin/quanly_khoahoc/danhsach_giangvien/index.php?CourseID=<?= $CourseID ?>" class="text-decoration-none text-center py-1 m-1 sidebar_button">Quay lại</a>
    </div>
  </div>
</div>
