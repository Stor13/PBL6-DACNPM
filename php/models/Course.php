...
class Course {
  ...
  public function create() {
    ...
    $this->CourseName = $this->preprocess_input($this->CourseName);
    $this->ProgressRatio = $this->preprocess_input($this->ProgressRatio);
    $this->MidtermRatio = $this->preprocess_input($this->MidtermRatio);
    $this->FinalRatio = $this->preprocess_input($this->FinalRatio);
